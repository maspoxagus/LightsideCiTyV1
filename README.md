{
    "cookies": [
        ...
        "deu-lhe um biscoito da sorte, tem escrito: \"Se voc\u00ea mecher o quadril, voc\u00ea vai pegar todas as garotas!\"",
    ...
    "love": [
        "deu-lhe <3 :purple_heart: :blue_heart: :green_heart: :yellow_heart:"
    ],
    "balls": [
    ...
    "jokenpo": "\/me %%NAME%% jogou: \"%%QUESTION%%\" a jogada de %%BOTNAME%% foi: \"%%RESPONSE%%\"",
    "nodatafound": "Dados anteriores n\u00e3o encontrados.",
    "currentlang": "\/me Idioma definido: %%LANGUAGE%%",
    "langerror": "\/me O idioma que voc\u00ea selecionou n\u00e3o est\u00e1 dispon\u00edvel. Por favor, visite %%LINK%% para encontrar uma lista de idiomas dispon\u00edveis.",
    ...
    "online": "\/me %%BOTNAME%% online!",
    "welcome": "Bem vindo(a) lindo(a) %%NAME%% <3",
    "welcomeback": "Bem-vindo(a) de volta %%NAME%% :two_hearts:",
    "songknown": "@%%NAME%%, essa m\u00fasica est\u00e1 no hist\u00f3rico.",
    "timelimit": "@%%NAME%%, sua m\u00fasica tem dura\u00e7\u00e3o maior que %%MAXLENGTH%% minutos. Voc\u00ea precisa ter permiss\u00e3o para tocar m\u00fasicas longas.",
    ...
    "isopen": "/me :game_die: Hora da Roleta @djs :game_die:",
    "isopen2": "/me :game_die: A roleta foi iniciada! Use !join para participar! (Jogo onde um participante aleat\u00f3rio \u00e9 movido para uma posi\u00e7\u00e3o aleat\u00f3ria na fila de espera)",
    ...
    "caps": "@%%NAME%%, desligue seu capslock, viado.",
    "askskip": "@%%NAME%%, n\u00e3o pe\u00e7a skips.",
    "spam": "\/me @%%NAME%%, n\u00e3o fa\u00e7a spam, por favor.",
    "palavrao": "\/me @%%NAME%%, n\u00e3o fale palavrão, por favor.",
    "roomadvertising": "@%%NAME%%, n\u00e3o poste link de outras comunidades, por favor.",
    "adfly": "Por favor @%%NAME%% , não divulgue links do plug aqui na sala, obrigado!",
    ...
    "autowoot": "\/me N\u00f3s recomendamos RCS woot para autowoot: https://rcs.radiant.dj/",
    "brandambassador": "\/me Um Embaixador de Marca \u00e9 a voz dos usu\u00e1rios da plug.dj. Eles promovem eventos, ajudam as comunidades e divulgam a plug.dj para todo o mundo.",
    ...
    "commandslink": "\/me Comandos do %%BOTNAME%%: http://goo.gl/ns73FL",
    ...
    "eta": "\/me @%%NAME%% voc\u00ea tocar\u00e1 em aproximadamente %%TIME%%, siacalme.",
    "facebook": "/me Participe do nosso grupo no Facebook: %%LINK%%",
    ...
    "kill": "\/me Desligando... xau gente :kissing_heart: ",
    ...
    "notavailable": "\/me @%%NAME%% Música indisponível :disappointed_relieved: ",
    ...
    "pong": "\/me Pong!",
    "reload": "\/me Reiniciando... Já volto migos.",
    ...
    "genres": "\/me Gêneros permitidos: Eletrônica (Exceto Trap Funk), Pop, Rock / Metal, Hip Hop / Rap, Reggae, Sertanejo",
    ...
    "songstatistics": "/me %%ARTIST%% :musical_note: %%TITLE%%: :+1: %%WOOTS%% | :purple_heart:  %%GRABS%% | :-1: %%MEHS%%",
    "thorNotClose": "\/me @%%NAME%% voc\u00ea n\u00e3o \u00e9 digno nem de chegar perto do martelo.",
    "thorcd": "\/me @%%NAME%% voc\u00ea pode tentar levantar o martelo em %%TIME%% minutos.",
    "thorWorthy": "\/me @%%NAME%% voc\u00ea \u00e9 d\u00edgno do martelo :hammer:. Parab\u00e9ns!",
    "thorNotWorthy": "\/me @%%NAME%% voc\u00ea n\u00e3o \u00e9 d\u00edgno do martelo."
}
